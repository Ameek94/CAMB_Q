...
def main():
    ...
    info = yaml_load(f'./spline_{nspline}_fixedV_camspec.yaml')
    # print(info)
    ...
    # save
    fname = f"best_result_{nspline}_{solver}_{maxfun}_Camspec_fixedV.txt"
    ...
    pdict['lengthscale'] = 0.09758613296694123
    ...
    plot_spline_quintessence(param_dict=param_dict,nspline=nspline,output_prefix=f"SplineQ_Camspec_fixedV")
