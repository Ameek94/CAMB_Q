...
pars = camb.set_params(V0= 1e-8,
                       dark_energy_model='QuintessenceSpline',
                       **vals_dict,phi_train=phi_train, V_train=V_train,nspline=nspline,)
...
# fig.tight_layout()
plt.savefig(f'SplineQ_{nspline}_summary_free.pdf',bbox_inches='tight')
# plt.show()
...
plt.savefig(f'SplineQ_wz_Hz_{nspline}_free.pdf',bbox_inches='tight')