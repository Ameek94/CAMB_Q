...
def main():
    ...
    # save
    fname = f"best_result_{nspline}_{solver}_{maxfun}_Camspec_varyDE.txt"
    ...
    plot_spline_quintessence(param_dict=param_dict,nspline=nspline,output_prefix=f"SplineQ_Camspec_varyDE")
